...
- **Global scope**: `/Users/aviksh/CodeWorld/codepuranx/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/aviksh/CodeWorld/codepuranx/.codex/notes/`)
...
2. Glob `/Users/aviksh/CodeWorld/codepuranx/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/Users/aviksh/CodeWorld/codepuranx/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/aviksh/CodeWorld/codepuranx/.codex/notes/` — works in any directory
