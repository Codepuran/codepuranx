...
```
Agent(
  prompt="Read /Users/aviksh/CodeWorld/codepuranx/.codex/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/aviksh/CodeWorld/codepuranx/.codex/get-shit-done/templates/VALIDATION.md`
