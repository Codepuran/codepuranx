...
```bash
INIT=$(node "/Users/aviksh/CodeWorld/codepuranx/.codex/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/aviksh/CodeWorld/codepuranx/.codex/get-shit-done/templates/spec.md.
