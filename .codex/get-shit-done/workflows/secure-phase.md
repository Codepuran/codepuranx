...
```
Agent(
  prompt="Read /Users/aviksh/CodeWorld/codepuranx/.codex/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/aviksh/CodeWorld/codepuranx/.codex/get-shit-done/templates/SECURITY.md`
