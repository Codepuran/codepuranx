...
INSTALL_JS_GLOBAL="/Users/aviksh/CodeWorld/codepuranx/.codex/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/aviksh/CodeWorld/codepuranx/.codex/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
