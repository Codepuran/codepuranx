...
```bash
INIT=$(node "/Users/aviksh/CodeWorld/codepuranx/.codex/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/aviksh/CodeWorld/codepuranx/.codex/get-shit-done/bin/gsd-tools.cjs" commit \
